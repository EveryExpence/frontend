...
export default function CategoriesScreen() {
  ...
  const loadCategories = useCallback(async () => {
    ...
    try {
      ...
      setCategories([]);
      Toast.show({
        text1: `${t("categories.load_failed")}: ${e?.message ?? String(e)}`,
        type: "error",
      });
    } finally {
      setIsLoading(false);
      ...
      <View className="flex-1 px-4 pt-4">
        {isLoading ? (
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <Text className="pt-4 text-lg text-theme-icon mb-4">
              ...
              <View>
                ...
                >
                  <MaterialCommunityIcons
                    ...
                    style={{ marginRight: 8 }}
                  />
                  <Text className="text-xl font-semibold text-theme-textLight">
