...
import { useIncomeInsights } from "@/hooks/use-income-insights";
...
const IncomeInsightsScreen: React.FC = () => {
  ...
  const { categoryGroups, chartData, totalDisplayLines, loading, error, refetch } =
    useIncomeInsights(startDate, endDate, accountId);
    ...
    <SafeAreaView className="flex-1 bg-transparent">
      ...
      >
        <Text className="text-[32px] font-bold text-theme-text mb-4">
          {t("dashboard.income_insights", "Income Insights")}
        </Text>
...
export default IncomeInsightsScreen;
